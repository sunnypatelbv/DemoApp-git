    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == 0 {
            ...
            if isEmailCell == true {
                ...
                cell.selectionStyle = .none
                cell.inputTxtField.placeholder = "Email"
                cell.inputTxtField.title = "Email"
                return cell
            }
            ...
            cell.submitBtn.backgroundColor = .darkGray
            cell.submitBtn.tintColor = .white
            cell.submitBtn.setTitle("Reset Password", for: .normal)
